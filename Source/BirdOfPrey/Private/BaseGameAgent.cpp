...
void ABaseGameAgent::BeginPlay() { Super::BeginPlay(); }
void ABaseGameAgent::Tick(float DeltaTime) { Super::Tick(DeltaTime); }
void ABaseGameAgent::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent) { Super::SetupPlayerInputComponent(PlayerInputComponent); }
void ABaseGameAgent::Reset() { Super::Reset(); }
void ABaseGameAgent::ChangeWeaponType() {}
FTransform ABaseGameAgent::GetWeaponSpawnTransform() { return FTransform::Identity; }
...
bool ABaseGameAgent::IsAlive() { return true; }
